 ...
 */
public class DesUtill {
    /** 加密、解密key. */
    private static final String PASSWORD_CRYPT_KEY = "kEHrDooxWHCWt890sMAkjalsd";
    /** 加密算法,可用 DES,DESede,Blowfish. */
    private final static String ALGORITHM = "DES";
    public static void main(String[] args) throws Exception {
    	Date d = new Date();
        String md5Password = String.valueOf(d.getTime());
        System.out.println(md5Password);
        String str = DesUtill.encrypt(md5Password);
        System.out.println("str: " + str);
        str = DesUtill.decrypt(str);
        System.out.println("str: " + str);
    }
