...
public class AccountsAccountDao extends MySqlCommandBase
{
    ...
    @Resource(name = "datacommandReadOnly")
    private DataCommand datacommandReadOnly;
    ...
    public AccountsAccount searchById(int id)
    {
        ...
        SqlParameter sqlParameter=new SqlParameter();
        sqlParameter.add(AccountsAccountMapping.Id,id);
        return this.dataCommand.executeEntity(sql, sqlParameter, AccountsAccount.class);
    }
    public PagedList<AccountsAccount> searchByPage(QueryCondition queryCondition) {
        PagedList<AccountsAccount> pagedList=this.searchByPage(queryCondition, AccountsAccount.class,datacommandReadOnly);
        return pagedList;
    }
